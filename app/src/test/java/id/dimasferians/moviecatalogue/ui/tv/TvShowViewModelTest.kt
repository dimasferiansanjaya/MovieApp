...
//        viewModel = FakeTvShowViewModel(repository)
//    }
//
//    @Test
//    fun `get remote paging data for tv show return success`() {
...
//
//            // When
//            whenever(repository.getRemotePagingTvShow()).thenReturn(fakeFlow)
//
//            // Then
//            viewModel.pagingDataTv.collectLatest {
//                expectedResult = it
//            }
//
//            /* verify method called */
//            verify(repository, times(1)).getRemotePagingTvShow()
//
